...
data_f = open('/home/philippk/Git/FAIRytail/astronaut-data-analysis-not-so-fair-main/data.json', 'r')
data_t = open('/home/philippk/Git/FAIRytail/astronaut-data-analysis-not-so-fair-main/data.csv','w')
g_file = 'myplot.png'
