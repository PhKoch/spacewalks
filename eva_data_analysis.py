...
def plot_cumulative_time_in_space(eva_data, graph_file):
    """
    Loads the dataframe and creates a figure. The figure is saved to the provided file path 
    as well as direct output to the screen

    Args:
        eva_df (pd.DataFrame): The input dataframe
        graph_file (str): The path to the output CSV file.
